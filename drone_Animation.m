...
D2R = pi/180;
R2D = 180/pi;
b   = 2;   % the length of total square cover by whole body of quadcopter in meter
a   = b/3;   % the legth of small square base of quadcopter(b/4)
H   = 0.05;  % hight of drone in Z direction (4cm)
...
%  drawnow
 ...
 for i = 1:length(x)
     ...
     rotation3 = makehgtform('zrotate',yaw(i)+45*D2R);
